package com.recipeek.ui.common.atom
...
import com.recipeek.ui.theme.Typography
...
fun TextField(
    ...
    ComposeTextField(
        ...
        placeholder = {
            Text(text = hint, style = style.textStyle, color = AppColorsTheme.colors.textHint)
        },
        ...
        trailingIcon = {
            AnimatedVisibility(
                ...
                IconButton(onClick = { onTextChanged("") }) {
                    Icon(painter = painterResource(id = R.drawable.ic_cross), contentDescription = "Close")
                }
            }
        },
